...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar [[data-slot=popover-content]_&]:bg-bg-tertiary bg-background/90[[data-slot=card-content]_&]:bg-transparent p-3 [--cell-size:--spacing(8)]",
      ...
      classNames={{
        ...
        dropdown: cn(
          "absolute inset-0 bg-bg-tertiary opacity-0",
